...
const ModalCreateUnit = ({ show, toggle }) => {

    const { isCreatingUnit } = useSelector(state => state.unitReducer)
        ...
        <Modal isOpen={show} toggle={toggle} >
            <Formik
                ...
                onSubmit={(values, formikBag) => {
                    ...
                    dispatch(createUnit(unit, toggle))
                ...
                return (
                    <Form>
                        <ModalHeader style={{ backgroundColor: '#14cc60' }} className='d-flex justify-content-center'>
                            <strong style={{ fontSize: '20px', color: 'white' }}>Crear Unidad de Medida</strong>
                        </ModalHeader>
                        ...
                        <ModalFooter className='d-flex justify-content-between'>
                            <div>
                                <Button style={{ backgroundColor: '#14cc60', borderColor: '#14cc60', marginRight: 10 }} disabled={isSubmitting || !isValid || isCreatingUnit} unit='submit'>Crear Unidad de Medida</Button>
