...
const ModalCreateMark = ({ show, toggle }) => {

    const { isCreatingMark } = useSelector(state => state.markReducer)
                ...
                return (
                    <Form>
                        <ModalHeader style={{ backgroundColor: '#14cc60' }} className='d-flex justify-content-center'>
                            <strong style={{ fontSize: '20px', color: 'white' }}>Crear Marca</strong>
                        </ModalHeader>
                        ...
                        <ModalFooter className='d-flex justify-content-between'>
                            <div>
                                <Button style={{ backgroundColor: '#14cc60', borderColor: '#14cc60', marginRight: 10 }} disabled={isSubmitting || !isValid || isCreatingMark} type='submit'>Crear Marca</Button>
...
export default ModalCreateMark
