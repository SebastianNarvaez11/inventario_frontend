...
const ModalCreateClient = ({ show, toggle }) => {

    const { isCreatingClient } = useSelector(state => state.clientReducer)
        ...
        <Modal isOpen={show} toggle={toggle} size='lg'>
            <Formik
                ...
                onSubmit={(values, formikBag) => {
                    ...
                    dispatch(createClient(client, toggle))
                ...
                return (
                    <Form>
                        <ModalHeader style={{ backgroundColor: '#14cc60' }} className='d-flex justify-content-center'>
                            <strong style={{ fontSize: '20px', color: 'white' }}>Crear Cliente</strong>
                        </ModalHeader>
                        ...
                        <ModalFooter className='d-flex justify-content-between'>
                            <div>
                                <Button style={{ backgroundColor: '#14cc60', borderColor: '#14cc60', marginRight: 10 }} disabled={isSubmitting || !isValid || isCreatingClient} type='submit'>Crear Cliente</Button>
