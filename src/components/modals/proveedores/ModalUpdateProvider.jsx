...
const ModalUpdateProvider = ({ show, data, toggle }) => {

    const { isUpdatingProvider } = useSelector(state => state.providerReducer)
        ...
        <Modal isOpen={show} toggle={toggle} size='lg'>
            <Formik
                ...
                onSubmit={(values, formikBag) => {
                    ...
                    dispatch(updateProvider(provider, toggle))
                ...
                return (
                    <Form>
                        <ModalHeader style={{ backgroundColor: '#ffb703' }} className='d-flex justify-content-center'>
                            <strong style={{ fontSize: '20px', color: 'white' }}>Actualizar Proveedor</strong>
                        </ModalHeader>
                        ...
                        <ModalFooter className='d-flex justify-content-between'>
                            <div>
                                <Button style={{ backgroundColor: '#14cc60', borderColor: '#14cc60', marginRight: 10 }} disabled={isSubmitting || !isValid || isUpdatingProvider} type='submit'>Actualizar Proveedor</Button>
